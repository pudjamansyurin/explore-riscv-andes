...
#ifndef __I2C_AE210P_H
#define __I2C_AE210P_H
...
#define APB_CLK_40MHZ			1
#define APB_CLK_60MHZ			0
...
typedef struct
{
	AE210P_I2C_RegDef*	reg;                // I2C register interface
	I2C_DMA*		dma_tx;
	I2C_DMA*		dma_rx;
